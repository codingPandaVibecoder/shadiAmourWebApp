...
async function sendVerificationEmail(email, code, username) {
  const subject = "Email Verification - shadiamour";
...
async function sendPasswordResetEmail(email, resetToken, username) {
  ...
  const subject = "Password Reset - shadiamour";
...
Need help? Contact us at support@shadiamour.com or WhatsApp: +447454516156
...
async function sendProfileApprovalEmail(email, username, name) {
  const subject = "🎉 Congratulations! Your Profile Has Been Approved - shadiamour";
  const profileUrl = `${process.env.BASE_URL || "https://shadiamour.com"}/account/info`;
  ...
  const htmlBody = `
    ...
    <head>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Profile Approved - shadiamour</title>
      <style>
        body { font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f9f9f9; }
        .container { max-width: 600px; margin: 0 auto; background: white; }
        .header { background: linear-gradient(135deg, #E91E63 0%, #673AB7 100%); color: white; padding: 30px 20px; text-align: center; }
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="message">
            We're thrilled to welcome you to the shadiamour community! Our team has reviewed your profile 
...
We're thrilled to welcome you to the shadiamour community. Your profile is now live and other members can view it and express interest.
...
async function sendMarriageGuide(email) {
  ...
  const subject = "Your Free Halal Marriage Guide — shadiamour 💌";
          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);max-width:600px;">
            ...
            <tr>
              <td style="background:linear-gradient(135deg,#E91E63 0%,#673AB7 100%);padding:36px 40px;text-align:center;">
                <h1 style="margin:0;color:#ffffff;font-size:26px;font-weight:700;font-family:'Playfair Display',Georgia,serif;">shadiamour</h1>
            ...
            <tr>
              <td style="padding:40px;">
                ...
                <p style="margin:0 0 8px;color:#6b7280;font-size:13px;line-height:1.6;">Ready to find your Muslim spouse? <a href="https://shadiamour.com/register" style="color:#E91E63;text-decoration:none;font-weight:600;">Create your free profile</a> on shadiamour and join thousands of serious Muslims looking for a halal marriage.</p>
              </td>
            </tr>
            <!-- Footer -->
            <tr>
              <td style="background:#f9fafb;padding:24px 40px;text-align:center;border-top:1px solid #f3f4f6;">
                <p style="margin:0 0 6px;color:#9ca3af;font-size:12px;">shadiamour &bull; London, UK &bull; <a href="mailto:contact@shadiamour.com" style="color:#9ca3af;">contact@shadiamour.com</a></p>
                <p style="margin:0;color:#d1d5db;font-size:11px;">You received this email because you requested our free guide at shadiamour.com</p>
              </td>
            </tr>
          </table>
        </td></tr>
